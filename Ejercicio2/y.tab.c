...
static const char *const yytname[] =
{
  ...
  "')'", "$accept", "command", "exp", "term", "factor", YY_NULLPTR
};
#endif
...
#line 18 "calc.y" /* yacc.c:1646  */
    {(yyval.expressionTree) = newTree();
(yyval.expressionTree)->root = (yyvsp[0].nodo);
print2DTree((yyval.expressionTree)->root,5);
}
...
#line 41 "calc.y" /* yacc.c:1646  */
    {
    (yyval.nodo) = newNode((yyvsp[0].car));
    (yyval.nodo)->left = NULL;
    (yyval.nodo)->right = NULL;
}
